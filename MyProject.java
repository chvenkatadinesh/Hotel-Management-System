...
class Login
{
	...
	{
		System.out.print("\t\t\t\t\u001B[33mEnter a again password: \u001B[0m");
	...
	{
		System.out.print("\t\t\t\t\u001B[33mEnter a again username: \u001B[0m");
			...
			else
			{
				...
				else
				{
					if(count_pass>=0)
					{
						...
						System.out.printf("\t\t\t\t+----------------------------------+\n");
						System.out.print("\t\t\t\t\u001B[35mSelect Your Option:\u001B[0m");
						int n2 = scr.nextInt();
						if(n2==1)
						{
							System.out.print("\u001B[33m\t\t\t\tEnter a  Register Mobile number: "+RESET);
							m = scr.nextLong();
							String numberString = (String) Long.toString(m);
							if(validmobile(numberString))
							{
